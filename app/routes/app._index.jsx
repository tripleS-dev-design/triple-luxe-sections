...
/* ===== Layout CSS (fix largeur colonne centrale) ===== */
const LAYOUT_CSS = `
  ...
  /* Cartes latérales (cachées par défaut) */
  .tls-left-explain, .tls-right-promo{ display:none; position:fixed; top:110px; z-index:55; pointer-events:auto; }
  .tls-left-explain{ left:24px; width:340px; }
  .tls-right-promo{ right:24px; width:300px; }

  /* Colonne centrale */
  .tls-main{ margin:0 24px; } /* par défaut: pleine largeur du conteneur Polaris */

  /* >=1500px: afficher la gauche seulement, pousser un peu le contenu */
  @media (min-width:1500px){
    .tls-left-explain{ display:block; }
    .tls-main{ margin-left:368px; margin-right:24px; }
  }

  /* >=1800px: afficher gauche + droite, marges des deux côtés */
  @media (min-width:1800px){
    .tls-right-promo{ display:block; }
    .tls-main{ margin-left:368px; margin-right:324px; } /* 340+28 | 300+24 */
  }
`;
...
const META = {
  ...
  "t2-social-proof": { title: "Social Proof", icon: StarIcon, desc: "Testimonials / customer reviews." },
    ...
    >
      ...
      <div className="tls-left-explain" aria-hidden={false}>
        <Card>
          <Box padding="300">
            <BlockStack gap="150">
              <Text as="h3" variant="headingSm">How Triple Theme Blocks-Sections works</Text>
      ...
      <div className="tls-right-promo" aria-hidden={false}>
        <Card>
          <Box padding="300">
            <BlockStack gap="150">
              <Text as="h3" variant="headingSm">Boost announcements (FREE)</Text>
