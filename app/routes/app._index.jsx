      ...
      <Box paddingBlock="200" paddingInline="100">
        <InlineStack align="space-between" blockAlign="center" gap="400" wrap={false}>
          ...
          <InlineStack gap="200">
            ...
            <Button
              url={editorLink({ shopSub, template: block.template, apiKey })}
              target="_blank"
              external
              icon={ViewIcon}
            >
      ...
      secondaryActions={[
        {
          ...
          url: editorLink({ shopSub, template: "index", apiKey }),
          target: "_blank",
          external: true,
        },
      ]}
        ...
        <Box padding="300">
          <BlockStack gap="200">
            ...
            <BlockStack gap="150">
              ...
              <Box>
                <Text as="p">
                  <strong>2) Add blocks</strong> — click “Add to theme” next to
                  any block below, or use these quick links:
                </Text>
